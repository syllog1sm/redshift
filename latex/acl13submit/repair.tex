...
\noindent\textbf{To summarize}, our non-monotnonic arc-eager system differs from
monotonic system by:
\begin{itemize}
...
\subsection{The Monotonic Arc-Eager Dynamic Oracle}
We now briefly describe the dynamic oracle for the arc-eager system. For more
details, see \cite{coling2012}. The oracle is computed by reasoning about the
...
\subsection{Dynamic Oracles for the Non-Monotonic Variants}
